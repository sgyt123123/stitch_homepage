...
export function AboutPage() {
  ...
  return (
    <main className="flex-grow pt-16 bg-background-light dark:bg-background-dark">
      <motion.section
        className="relative"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div
          className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center gap-6 bg-cover bg-center bg-no-repeat p-4 text-center"
          style={{
        ...
        >
          ...
          <motion.div 
            className="absolute bottom-10 flex flex-col items-center gap-2 text-white/80"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.8, delay: 1 }}
          >
            <span className="text-sm">向下滑动</span>
            <motion.span 
